...
def _pbhook(numblocks, blocksize, filesize, url=None,dp=None):
    try:
        ...
        percent = 100
        dp.update(percent)
        print "airplay: DOWNLOAD FAILED" # need to get this part working        
    if dp.iscanceled(): 
        print "airplay: DOWNLOAD CANCELLED" # need to get this part working
        dp.close()
 
def tools_downloadLibShairport():
  print "airplay: try to fetch libshairport"  
  url = "none"
  dest = "none"
